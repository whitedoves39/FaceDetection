...
Bill=face_recognition.load_image_file("./img/known/Bill Gates.jpg")
Bill_encoding1=face_recognition.face_encodings(Bill)[0]

Joe=face_recognition.load_image_file("./img/known/joebiden.jpg")
Joe_encoding1=face_recognition.face_encodings(Joe)[0]

Steve=face_recognition.load_image_file("./img/known/stevejobs.jpg")
Steve_encoding1=face_recognition.face_encodings(Steve)[0]

Elon=face_recognition.load_image_file("./img/known/Elon Musk.jpg")
Elon_encoding1=face_recognition.face_encodings(Elon)[0]

Campbell=face_recognition.load_image_file("./img/known/Campbell.jpg")
Campbell_encoding1=face_recognition.face_encodings(Campbell)[0]

Duncan=face_recognition.load_image_file("./img/known/Duncan.jpg")
Duncan_encoding1=face_recognition.face_encodings(Duncan)[0]

Garth=face_recognition.load_image_file("./img/known/Garth.jpg")
Garth_encoding1=face_recognition.face_encodings(Garth)[0]

Keast=face_recognition.load_image_file("./img/known/Keast.jpg")
Keast_encoding1=face_recognition.face_encodings(Keast)[0]

Kim=face_recognition.load_image_file("./img/known/Kim.jpg")
Kim_encoding1=face_recognition.face_encodings(Kim)[0]

VanD=face_recognition.load_image_file("./img/known/VanD.jpg")
VanD_encoding1=face_recognition.face_encodings(VanD)[0]
